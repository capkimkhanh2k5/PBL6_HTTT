# Task Assignment for worker_2 (Replacement for worker_1)
...
1. **Domain & Persistence (M1)**:
   - Fix `CategoryJpaEntity.java`: change `@Table(name = "categorys")` to `@Table(name = "categories")`, add `@Column(unique = true)` on `slug`, ensure fields match design.
...
You are worker_2, replacing worker_1.
Your working directory is: /Users/capkimkhanh/.gemini/antigravity/worktrees/PBL6/implement_categories_module_api/.agents/worker_2
Read /Users/capkimkhanh/.gemini/antigravity/worktrees/PBL6/implement_categories_module_api/.agents/worker_2/DISPATCH.md, /Users/capkimkhanh/.gemini/antigravity/worktrees/PBL6/implement_categories_module_api/.agents/ORIGINAL_REQUEST.md, and /Users/capkimkhanh/.gemini/antigravity/worktrees/PBL6/implement_categories_module_api/PROJECT.md.
