...
class AuthenticationControllerTest {
    ...
    void shouldLoginAndReturnCookies() throws Exception {
        ...
        LoginResult result = new LoginResult("access-token", "refresh-token", UUID.randomUUID(), "test@example.com", "CUSTOMER");
    ...
    void shouldRefreshTokenSuccessfully() throws Exception {
        LoginResult result = new LoginResult("new-access-token", "new-refresh-token", UUID.randomUUID(), "test@example.com", "CUSTOMER");
    ...
    void shouldFailRefreshWhenTokenInvalidAndClearCookie() throws Exception {
        when(refreshTokenUseCase.execute("invalid-refresh-token")).thenThrow(new InvalidCredentialsException("Invalid refresh token"));
